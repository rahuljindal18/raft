        ...
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed font-medium">
                <a href="tel:+919560333643" className="hover:text-green-600 transition-colors">+91-9560333643</a> <br />
            ...
            >
              ...
              <p className="text-gray-500 leading-relaxed font-medium">
                <a href="mailto:hr@raftconsulting.in" className="hover:text-green-600 transition-colors">hr@raftconsulting.in</a> <br />
